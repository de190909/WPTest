...
class acf_field_image_select extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-image_select', get_template_directory_uri().'/inc/admin/plugins/acf-image-select/js/image-select.js' );
		wp_enqueue_script('acf-input-image_select');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-image_select', get_template_directory_uri().'/inc/admin/plugins/acf-image-select/css/image-select.css' ); 
