...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post post-format-quote wow fadeInUp'); ?>>
	...
	<?php if( !is_singular() && $post_header && has_post_thumbnail() || is_singular() && has_post_thumbnail() ) : ?>
		<header class="entry-header">
			...
			echo '<i class="post-icon fa fa-quote-right fa-5x"></i>';
			echo '<span class="post-spec"><em>"'.$featured_quote.'"</em></span>';
